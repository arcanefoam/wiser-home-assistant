...
// TODO You need to replace all instances of "action-handler-wiser-home" with "action-handler-<your card name>"
customElements.define('action-handler-wiser-home', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-wiser-home')) {
    return body.querySelector('action-handler-wiser-home') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-wiser-home');
